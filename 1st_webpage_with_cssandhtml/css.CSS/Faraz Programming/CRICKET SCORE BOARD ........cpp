...
int main() {
	...
	//int tover=30;
	double pace;
	int splayer1[11];,splayer2,splayer3,splayer4,splayer5,splayer6,splayer7,splayer8,splayer9,splayer10,splayer11;
	...
	//	SECOND TEAM;	
		...
		cout << tplayer2<< " : ";
		cin >>	stplayer2;
		if (stplayer1+stplayer2>splayer1+splayer2+splayer3+splayer4+splayer5+splayer6+splayer7+splayer8+splayer9+splayer10+splayer11){
			break;
			cout << endl<<team2<<" WON";
		}
		else {
		...
		cout << tplayer2<< " : ";
		cin >>	stplayer2;
		if (stplayer1+stplayer2+stplayer3>splayer1+splayer2+splayer3+splayer4+splayer5+splayer6+splayer7+splayer8+splayer9+splayer10+splayer11){
			break;
			cout<<endl << team2<< " WON"; 
		}else {
		...
		cout << tplayer4<< " : ";
		cin >>	stplayer4;
		if (stplayer1+stplayer2+stplayer3+stplayer4>splayer1+splayer2+splayer3+splayer4+splayer5+splayer6+splayer7+splayer8+splayer9+splayer10+splayer11){
		break;
		cout << endl << team2<< " WON";
		}else {
		...
		cout << tplayer4<< " : ";
		cin >>	stplayer4;
		if (stplayer1+stplayer2+stplayer3+stplayer4+stplayer5>splayer1+splayer2+splayer3+splayer4+splayer5+splayer6+splayer7+splayer8+splayer9+splayer10+splayer11){
		break;
		cout << endl << team2 << " WON";
		}else {
		...
		cout << tplayer6<< " : ";
		cin >>	stplayer6;
		if (stplayer1+stplayer2+stplayer3+stplayer4+stplayer5+stplayer6>splayer1+splayer2+splayer3+splayer4+splayer5+splayer6+splayer7+splayer8+splayer9+splayer10+splayer11){
		break ;
		cout << endl << team2<< " WON";
		}else{
		...
		cout << tplayer6<< " : ";
		cin >>	stplayer6;
		if (stplayer1+stplayer2+stplayer3+stplayer4+stplayer5+stplayer6+stplayer7>splayer1+splayer2+splayer3+splayer4+splayer5+splayer6+splayer7+splayer8+splayer9+splayer10+splayer11){
		break;
		cout << endl << team2 << " WON";
		}else{
		...
		cout << tplayer8<< " : ";
		cin >>	stplayer8;
			if (stplayer1+stplayer2+stplayer3+stplayer4+stplayer5+stplayer6+stplayer7+stplayer8>splayer1+splayer2+splayer3+splayer4+splayer5+splayer6+splayer7+splayer8+splayer9+splayer10+splayer11){
		break;
		cout << endl << team2 << " WON";
		}else {
		...
		cout << tplayer8<< " : ";
		cin >>	stplayer8;
		if (stplayer1+stplayer2+stplayer3+stplayer4+stplayer5+stplayer6+stplayer7+stplayer8+stplayer9>splayer1+splayer2+splayer3+splayer4+splayer5+splayer6+splayer7+splayer8+splayer9+splayer10+splayer11){
		break;
		cout << endl <<team2<< " WON";
		}else {
		...
		cout << tplayer10<< " : ";
		cin >>	stplayer10;
		if (stplayer1+stplayer2+stplayer3+stplayer4+stplayer5+stplayer6+stplayer7+stplayer8+stplayer9+stplayer10>splayer1+splayer2+splayer3+splayer4+splayer5+splayer6+splayer7+splayer8+splayer9+splayer10+splayer11){
		break;
		cout <<endl<< team2<< " WON";
		}else{
		...
		cout << tplayer10<< " : ";
		cin >>	stplayer10;
		if (stplayer1+stplayer2+stplayer3+stplayer4+stplayer5+stplayer6+stplayer7+stplayer8+stplayer9+stplayer10+stplayer11>splayer1+splayer2+splayer3+splayer4+splayer5+splayer6+splayer7+splayer8+splayer9+splayer10+splayer11){
		break;
		cout << endl << team2 <<" WON";
		}else {
